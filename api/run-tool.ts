...
export default async function handler(req: Req, res: Res) {
  // Pull credentials securely from Vercel's environment environment panels
  ...
  try {
    ...
    // 4. Increment usage counter and assign a rolling 24-hour expiration token window
